...
const DATA = {
  ...
  europe_alt: {
    ...
    points: [
      ...
      "🇮🇹 Rome · 🇪🇸 Madrid · 🇪🇸 Barcelona · 🇵🇹 Lisbon: ZERO nonstop award space from NYC OR Boston, either month. Only connecting awards exist — and the cheap ones are mixed-cabin (Rome verified economy-across-the-Atlantic on the seat map). NOT lie-flat. (Iberia nonstops to Madrid may hold cheaper space the search can't see — needs an Iberia login to check; the rumored 'best business deal' lives there.)",
