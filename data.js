...
const DATA = {
  ...
  europe_alt: {
    ...
    points: [
      ...
      "🇮🇹 ROME — IS available lie-flat with a stopover on Air France (a stopover is fine per Mom). Checked live & logged in: NYC→Rome connecting business via CDG, 152,000 miles + $361 each way, every date in May 2027. Confirmed the transatlantic leg is AF flight 0011 on an Airbus A350-900 (true flat bed) — booked Air France business end-to-end, so it is NOT the Aeroplan mixed-cabin trap; the ocean crossing really is lie-flat, then a short CDG→Rome hop. Cheaper than nonstop Paris. Caveat: still no true saver space — ~152k each way = ~304k per person round-trip = ~608k for two. Real lie-flat Rome option ✅, but ~2× the ~300k-for-two budget. (Aeroplan's cheaper 75k Rome award is the mixed-cabin trap — avoid that one; THIS Air France one is the legit lie-flat path to Rome.)",
      "🇪🇸 Madrid · 🇪🇸 Barcelona · 🇵🇹 Lisbon: no nonstop award space found from NYC or Boston. Iberia's own nonstops to Madrid may hold cheaper saver space the search can't see — needs an Iberia login to check; the rumored 'best business deal' lives there.",
      "✈️ Milan (for Ashley): Emirates A380 nonstop from JFK, 100,000 each way, lie-flat — Oct 12, 15, 25, 26, 27 · May 4, 5, 9, 10.",
      "BOTTOM LINE: two real lie-flat paths on Amex points — (1) LONDON, cheapest by far (45k Avios each way, nonstop, ~$700–1,000/person UK tax); (2) ROME via Air France with a CDG stopover, confirmed lie-flat A350 across the Atlantic, but ~152k miles each way (~608k for two round-trip) — over the ~300k-for-two budget. Paris is also lie-flat but pricier (182k). Madrid/Barcelona still pending an Iberia login. (The old Aeroplan 75k Rome cards below are the mixed-cabin trap — do NOT book those; the Air France Rome routing above is the legit one.)"
    ]
  },
